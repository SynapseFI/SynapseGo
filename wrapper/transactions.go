...
func (c *ClientCredentials) GetClientTransactions(cred ClientCredentials) Users {
...
func (c *ClientCredentials) GetUserTransactions(cred ClientCredentials, userID string) Users {
